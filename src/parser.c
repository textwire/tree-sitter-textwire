...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_multiply, 3, 0, 2),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_modulo, 3, 0, 2),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_divide, 3, 0, 2),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_plus, 3, 0, 2),
  ...
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 5, 0, 4),
  [200] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 6, 0, 7),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_expression, 1, 0, 0),
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_infix_expression, 1, 0, 0),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_literal, 1, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_prefix_minus, 2, 0, 0),
